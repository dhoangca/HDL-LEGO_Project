...
{{-- @section('content_index') --}}
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            @foreach ($FeaturedRecent1 as $new1)
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    <div class="product-item bg-light mb-4">
                        ...
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="">{{$new1->pName}}</a>
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>${{$new1->pPrice}}</h5><h6 class="text-muted ml-2"><del>${{$new1->pPricePro}}</del></h6>
                            </div>
            ...
            @foreach ($FeaturedRecent0 as $new0)
                <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                    <div class="product-item bg-light mb-4">
                        ...
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="">{{$new0->pName}}</a>
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>${{$new0->pPrice}}</h5><h6 class="text-muted ml-2"><del>${{$new0->pPricePro}}</del></h6>
                            </div>
                            <div class="d-flex align-items-center justify-content-center mb-1">
                                <small class="fa fa-star text-primary mr-1"></small>
                                <small class="fa fa-star text-primary mr-1"></small>
