    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link" href="{{route('admin.tableusers')}}">
                ...
                <div class="collapse" id="pagesmanagecategory" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{route('admin.indextablecategory')}}">Manage Categories</a>
                    </nav>
                </div>
                <a class="nav-link" href="{{route('admin.tablecategory')}}">
                    <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                    Tables
                </a>
