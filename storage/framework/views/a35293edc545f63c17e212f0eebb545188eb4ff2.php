    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <form action="" method="POST">
                ...
                <input type="text" class="form-control" name="CategoryName" value ="<?php echo e($cate->CategoryName); ?>" placeholder="tên thể loại...">
                </div>
                <div class="mb-3">
                    <label for="">Category Description</label>
                    <input type="text" class="form-control" name="CategoryDescription" value ="<?php echo e($cate->description); ?>" placeholder="mô tả..." >
                </div>
...
<!-- js -->
<?php echo $__env->make('Back_end.layout.js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\AllLaravel\HDL-LEGO_Project\resources\views/Back_end/content/editCategory.blade.php ENDPATH**/ ?>